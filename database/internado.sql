...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-05-2017 a las 12:36:49
...
--
-- Base de datos: `sistema_internado`
--
...
CREATE TABLE `login` (
  ...
  `nombre_lo` varchar(45) NOT NULL,
  `apellido_lo` varchar(45) NOT NULL,
  `clave` varchar(45) NOT NULL,
  `fecha_lo` varchar(45) NOT NULL,
  `estado_lo` varchar(45) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
ALTER TABLE `estudiantes`
  ...
  ADD CONSTRAINT `fk_estudiantes_login1` FOREIGN KEY (`login_id_login`) REFERENCES `login` (`id_login`) ON DELETE NO ACTION ON UPDATE NO ACTION,
