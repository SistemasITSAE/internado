  ...
  <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-4 col-md-offset-1 col-sm-8 col-sm-offset-2">
            <div class="panel panel-info" >
              <div class="panel-heading">
               <div class="panel-title" align="center">solo bautizados</div>
               </div>
               <div style="padding-top:30px" class="panel-body" >
                 ...
                 <label for="">Iglesia a la que Asiste:</label>
               ...
               <div class="col-sm-12" align="center">
                 <div class="form-inline">
                 <div class="form-group">
                 <label for="">Cargos desempeñados:</label>
                 <input name="remitosucursal" id="remitosucursal" type="text" required class="form-control">
               </div>
               </div> <br>
               </div> <br>
               ...
               <div class="col-sm-12" align="center">
                 <div class="form-inline">
                 <div class="form-group">
                 <label for="">Familiares Adventista:</label>
                 <input name="remitosucursal" id="remitosucursal" type="text" required class="form-control">
               </div>
               </div> <br>
               </div> <br>
