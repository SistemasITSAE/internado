  ...
  <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-1 col-sm-8 col-sm-offset-2">
            <div class="panel panel-info" >
              <div class="panel-heading">
               <div class="panel-title" align="center">Datos De Salud</div>
               </div>
               ...
               <div class="col-sm-12" align="center">
                 <div class="form-inline">
                 <div class="form-group">
                 <label for="">Emfermedades Padecidas:</label>
                 <input name="remitosucursal" id="remitosucursal" type="text" required class="form-control">
               </div>
               </div> <br>
               </div> <br>
               ...
               <div class="col-sm-12" align="center">
                 <div class="form-inline">
                 <div class="form-group">
                 <label for="">¿es alergico a un medicamento?</label>
                 <input name="remitosucursal" id="remitosucursal" type="text" required class="form-control">
               </div>
               </div> <br>
               </div> <br>
               ...
               <div class="col-sm-12" align="center">
                 <div class="form-inline">
                 <div class="form-group">
                 <label for="">Medicina que toma regularmente:</label>
                 <input name="remitosucursal" id="remitosucursal" type="text" required class="form-control">
               </div>
               </div> <br>
               </div> <br>
               ...
               <div class="col-sm-12" align="center">
                 <div class="form-inline">
                 <div class="form-group">
                 <label for="">¿Adolece de Alguna enfermedad o impedimento fisico?</label>
                 <input name="remitosucursal" id="remitosucursal" type="text" required class="form-control">
               </div>
               </div> <br>
               </div> <br>
