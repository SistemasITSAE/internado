              ...
              <section class="panel">
                ...
                <div class="panel-body">
                  <div class="form">
                    ...
                    <form class="form-validate form-horizontal" id="registrar_form" method="post" action="">


                     <?php

echo form_open('Student/student_view', 'class="myclass", method="post"');
?>
...
?></div>
                  ...
                  <div class="row" >
<div clas="col" >
<?php echo form_submit('registrar', 'guardar', 'class="btn btn-success" '); ?>
                  </div>
                  <div class="col" >
